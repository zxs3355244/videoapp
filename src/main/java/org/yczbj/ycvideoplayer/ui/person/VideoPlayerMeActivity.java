...
public class VideoPlayerMeActivity extends BaseActivity implements VideoPlayerMeContract.View{
            ...
            public void onVideoControlClick(int type) {
                switch (type) {
                    case ConstantKeys.VideoControl.DOWNLOAD:
                        ToastUtil.showToast(VideoPlayerMeActivity.this,
                                "下载音视频");
                        break;
    ...
    private void initYCRefreshView() {
        ...
        final RecycleViewItemLine line = new RecycleViewItemLine(this,
                ...
                SizeUtil.dip2px(this,1),Color.parseColor("#f5f5f7"));
        ...
        recyclerView.setRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                SwipeRefreshLayout swipeRefreshLayout = recyclerView.getSwipeToRefresh();
    ...
    private void initTopHeaderView() {
        adapter.addHeader(new RecyclerArrayAdapter.ItemView() {
            ...
            public void onBindView(View headerView) {
                ...
                ImageView ivPlayerColletction = (ImageView) headerView.findViewById(R.id.iv_player_collection);
                ...
                View.OnClickListener listener = new View.OnClickListener() {
                 ...
                 ivPlayerColletction.setOnClickListener(listener);
    ...
    private void initHeaderTitle() {
        adapter.addHeader(new RecyclerArrayAdapter.ItemView() {
            @Override
            public View onCreateView(ViewGroup parent) {
                return LayoutInflater.from(VideoPlayerMeActivity.this).inflate(R.layout.head_video_player_title,parent,false);
            }
    ...
    private void initHorizontalView() {
        adapter.addHeader(new RecyclerArrayAdapter.ItemView() {
            ...
            public View onCreateView(ViewGroup parent) {
                ...
                recyclerView.setLayoutManager(new LinearLayoutManager(parent.getContext(),LinearLayoutManager.HORIZONTAL,
                        false));
                recyclerView.addItemDecoration(new SpaceViewItemLine(SizeUtils.dp2px(8)));
                narrowAdapter.setMore(R.layout.view_video_more_horizontal,
    ...
    private void initVideoContentView() {
        adapter.addHeader(new RecyclerArrayAdapter.ItemView() {
            @Override
            public View onCreateView(ViewGroup parent) {
                return LayoutInflater.from(VideoPlayerMeActivity.this).
                        inflate(R.layout.head_video_player_content,parent,false);
            }
...
final List<DialogListBean> list = new ArrayList<>();
    ...
    dialog.setViewListener(new BottomDialogFragment.ViewListener() {
        ...
        public void bindView(View v) {
            ...
            final RecycleViewItemLine line = new RecycleViewItemLine(VideoPlayerMeActivity.this,
                    LinearLayout.HORIZONTAL,SizeUtils.dp2px(1),
