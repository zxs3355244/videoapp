...
public class HomeFragment extends BaseFragment implements View.OnClickListener {
    ...
    private void initBannerView() {
        ...
        BaseDelegateAdapter adapter = new BaseDelegateAdapter(activity,new LinearLayoutHelper(),
                R.layout.view_vlayout_banner,1,Constant.viewType.typeBanner){
            @Override
    ...
    private void initFiveButtonView() {
        BaseDelegateAdapter adapter = new BaseDelegateAdapter(activity,new LinearLayoutHelper(),
                R.layout.view_vlayout_button,1,Constant.viewType.typeView) {
            @Override
            public void onBindViewHolder(BaseViewHolder holder,int position) {
                super.onBindViewHolder(holder,position);
    ...
    private  void initListFirstView() {
        ...
        BaseDelegateAdapter adapter = new BaseDelegateAdapter(activity,gridLayoutHelper,R.layout.view_vlayout_grid,
                4,Constant.viewType.typeGv) {
            @Override
            public void onBindViewHolder(BaseViewHolder holder, int position) {
                super.onBindViewHolder(holder, position);
    ...
    private void initRecyclerView() {
        BaseDelegateAdapter adapter = new BaseDelegateAdapter(activity,new LinearLayoutHelper(),
            ...
            public void onBindViewHolder(BaseViewHolder holder, int position) {
                ...
                recycler.setLayoutManager(new LinearLayoutManager(activity,LinearLayoutManager.HORIZONTAL,
                        false));
...
//        };
    ...
    private void initFirstAdView() {
        BaseDelegateAdapter adAdapter = new BaseDelegateAdapter(activity, new LinearLayoutHelper(),
    ...
    private void initSecondAdView() {
        BaseDelegateAdapter adapter = new BaseDelegateAdapter(activity,new LinearLayoutHelper(),
                R.layout.view_vlayout_ad,1,Constant.viewType.typeAd2) {
    ...
    private void initListThirdView() {
        ...
        BaseDelegateAdapter adapter = new BaseDelegateAdapter(activity,
            ...
            public void onBindViewHolder(BaseViewHolder holder, int position) {
                ...
                imageView.setImageResource(R.drawable.bg_small_autumn_tree_min);
            }
        };
        mAdapters.add(adapter);
        initMoreView(3);
    ...
    private void initListFourView() {
        ...
        BaseDelegateAdapter adapter = new BaseDelegateAdapter(activity,linearLayoutHelper,R.layout.view_vlayout_news,
                3,Constant.viewType.typeList4) {
            @Override
            public void onBindViewHolder(BaseViewHolder holder, int position) {
                super.onBindViewHolder(holder, position);
    ...
    private void initListFiveView() {
        ...
        BaseDelegateAdapter adapter = new BaseDelegateAdapter(activity,gridLayoutHelper,R.layout.view_vlayout_grid,6,Constant.viewType.typeGvBottom) {
            ...
            public void onBindViewHolder(BaseViewHolder holder, int position) {
                super.onBindViewHolder(holder, position);
                ImageView imageView = holder.getView(R.id.iv_image);
                imageView.setImageResource(R.drawable.bg_small_leaves_min);
            ...
            public void onBindViewHolder(BaseViewHolder holder, int position) {
                ...
                switch (type){
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        holder.setText(R.id.tv_title,"趋势动态");
                        break;
                    case 5:
                    ...
                    case 6:
                        ...
                        break;
                    default:
                        holder.setText(R.id.tv_title,"这是个标题");
                        break;
                }
