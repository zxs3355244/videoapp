    ...
    private void addHeader() {
        adapter.addHeader(new RecyclerArrayAdapter.ItemView() {
            ...
            public View onCreateView(ViewGroup parent) {
                return LayoutInflater.from(VideoContentActivity.this).inflate(R.layout.head_video_player,parent,false);
                        ...
                        switch (view.getId()) {
                            case R.id.btn_1:
                                if(videoPlayer.isIdle()) {
                                    ToastUtil.showToast(VideoContentActivity.this,
                                            "要点击播放后才能进入小窗口");
                                } else {
