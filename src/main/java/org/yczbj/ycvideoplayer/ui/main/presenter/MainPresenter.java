...
public class MainPresenter implements MainContract.Presenter {
    ...
    public ArrayList<CustomTabEntity> getTabEntity() {
        ...
        String [] mainTiltes = activity.getResources().getStringArray(R.array.main_title);
        for (int i = 0;i < mainTiltes.length;i++) {
            ...
            mTabEntities.add(new TabEntity(mainTiltes[i],selectId,unSelectId));
        }
